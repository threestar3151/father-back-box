...
<body>
    <div class="container">
        <div class="summary">
            <h2>💡 핵심 요약 (결론)</h2>
            <p>최근 6개월(2025년 하반기~2026년 상반기) 빅데이터 및 소비자 리뷰를 분석한 결과, <strong>30~40만 원대 예산</strong>으로 <strong>최상위 화질, 모바일 다이렉트 연동, 그리고 광주 및 전국 단위의 확실한 오프라인 A/S망</strong>을 모두 충족하는 실사용 만족도 최우수 5개 모델입니다.</p>
        </div>

        <div class="item-card">
            <div class="item-title"><span class="rank">1위</span> 아이나비 QXD1 PLUS (64GB)</div>
            <ul class="specs">
                <li><strong>예상 가격:</strong> <span>약 39~42만 원대 (예산 내 프리미엄 최상위)</span></li>
                ...
                <li><strong>A/S 및 리뷰:</strong> <span>프리미엄 하이엔드 시장 판매량 및 리뷰 평점 1위. 광주광역시 내 직영 프리미엄 스토어 다수 운영으로 대면 A/S 및 사후 관리가 가장 확실함.</span></li>
            </ul>
        ...
        <div class="item-card">
            ...
            <ul class="specs">
                <li><strong>예상 가격:</strong> <span>약 33~35만 원대 (고용량 메모리 포함 가성비 우수)</span></li>
                ...
                <li><strong>A/S 및 리뷰:</strong> <span>4K 지원 모델 중 실사용자 가성비 만족도 최고점. 광주/전남 지역 촘촘한 공식 서비스 지정점 및 대리점망 운영.</span></li>
            </ul>
        ...
        <div class="item-card">
            ...
            <ul class="specs">
                ...
                <li><strong>A/S 및 리뷰:</strong> <span>여름철 발열에 강한 내구성으로 호평. 광주 시내 오프라인 '만도플라자'를 통한 신속한 대면 A/S 처리 접근성 우수.</span></li>
            </ul>
        ...
        <div class="item-card">
            ...
            <ul class="specs">
                ...
                <li><strong>A/S 및 리뷰:</strong> <span>1.5초 초고속 부팅과 초저전력 주차 녹화(최장 7개월 대기) 기능으로 실용성 리뷰 최상. 2년 무상 A/S 정책 및 지역 장착점 연계 시스템 탄탄함.</span></li>
            </ul>
